...
export default function ServicesAIFilms({ onOpenContact }) {
  ...
  return (
    <section id="ai-films" className="py-24 relative border-t border-slate-100 bg-white">
      
      {/* Ambient background glow */}
      <div className="absolute top-1/2 right-0 w-96 h-96 bg-blue-500/5 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16 reveal-fade-up">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-slate-900">
            AI Film & <span className="text-blue-600">VFX Production</span> Studio
          </h2>
        ...
        {/* Services Grid (Minimalist Theme) */}
        <div className="grid md:grid-cols-2 gap-6">
          {aiFilmServices.map((service, index) => (
            <div
              key={index}
              className="minimal-card p-8 flex flex-col justify-between reveal-scale-up group"
            ...
            >
              ...
              <div>
                <div className="grid grid-cols-2 gap-2.5 border-t border-slate-100 pt-5">
        ...
        <div className="mt-16 text-center reveal-fade-up">
          <button
            ...
            className="px-8 py-4 rounded-2xl font-bold text-white bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/10 hover:shadow-xl transition-all duration-300 text-sm inline-flex items-center gap-2 cursor-pointer transform hover:-translate-y-0.5"
          >
